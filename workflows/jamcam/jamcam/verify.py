...
os.environ["LOCAL_DATA_DIR"] = os.path.join(
    os.getenv("LOCAL_PROJECT_DIR", os.getcwd()), "data"
)
os.environ["LOCAL_EXPERIMENT_DIR"] = os.path.join(
    os.getenv("LOCAL_PROJECT_DIR", os.getcwd()), "yolo_v4"
)
...
if os.path.exists(os.path.join(DATA_DIR, "test/labels")) and os.path.exists(
    ...
    for tt in ["test", "train"]:
        ...
        for file in files:
            ...
            labels[
                ...
                file.replace("labels_raw", "labels"),
                sep=" ",
                index=False,
                header=False,
            )
