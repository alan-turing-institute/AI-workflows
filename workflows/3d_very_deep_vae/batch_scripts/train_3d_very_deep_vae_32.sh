...
# Set name of job
#SBATCH --job-name=3d_very_deep_vae_32
...
container_command="train_vae_model.py --json_config_file VeryDeepVAE_32x32x32.json --nifti_dir ./data --output_dir ./output_$job_id"
# Command to execute
