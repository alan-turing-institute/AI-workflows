...
# Set name of job
#SBATCH --job-name=sciml_dms_structure
...
container_command="sciml-bench run dms_structure --output_dir=./output_$job_id --dataset_dir=/scratch_mount/dms_sim"
# Command to execute
